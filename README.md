<h1>A Simple Calculator in Java using AWT!</h1>  
...
Create a new Java project in your favourite IDE and make sure to have AWT imported.
...
In the ActionListener, define the calculation logic. Use a StringBuilder to store the input expression and operands. When the equals button is pressed, evaluate the expression and display the result.
